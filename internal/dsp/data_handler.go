...
func (h dataHandler) handleData(w http.ResponseWriter, r *http.Request) {
	...
	//
	// Another of this connector's comparison forms, and hand-rolled rather
	// than shared on purpose. refuseIfNotParty
	...
	// would serve it to any roster participant. Factoring them together is
	// what would hand it over — see DECISIONS.md section 32.2.
